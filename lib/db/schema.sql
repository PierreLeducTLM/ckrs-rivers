...
-- idx_push_devices_subscriber is created in the ALTER TABLE block of migrate.ts
-- to avoid referencing subscriber_id before the column is added on existing databases.
