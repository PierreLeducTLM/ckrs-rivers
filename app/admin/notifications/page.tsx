...
const NOTIFICATIONS: NotificationDef[] = [
  ...
  },
  {
    ...
    cooldown: "12h",
    trigger: "evaluate-alerts",
    condition: "Currently runnable but forecast shows flow will exit range within 12 hours",
    canSchedule: true,
  },
  {
    type: "dropping-out",
  ...
  {
    type: "window-extended",
    emoji: "\u2795",
    label: "Window Extended",
    priority: "normal",
    cooldown: "24h",
    trigger: "evaluate-alerts",
    condition: "The number of consecutive runnable forecast days increased by \u22651 day compared to previous evaluation",
    canSchedule: true,
  },
  {
    type: "window-shortened",
    emoji: "\u2796",
    label: "Window Shortened",
    priority: "normal",
    cooldown: "24h",
    trigger: "evaluate-alerts",
    condition: "The number of consecutive runnable forecast days decreased compared to previous evaluation (was >0)",
    canSchedule: true,
  },
  {
    type: "season-opener",
    ...
    priority: "high",
    cooldown: "365d",
    trigger: "evaluate-alerts (external flag)",
    condition: "First time station becomes runnable this season. Requires isSeasonFirst flag set by task after checking alert history.",
    canSchedule: false,
  },
  {
    ...
    priority: "normal",
    cooldown: "7d",
    trigger: "send-digest (cron: Wed/Thu 6 PM ET)",
    condition: "Weekly digest email sent every Wednesday and Thursday at 6 PM Eastern. Contains all subscribed rivers with current flow and 3-day forecast.",
    canSchedule: false,
  },
  {
    type: "spring-melt-update",
    emoji: "\uD83C\uDF0A",
    label: "Spring Melt Update",
    priority: "low",
    cooldown: "7d",
    trigger: "External / manual",
    condition: "Spring melt event update. Not automatically triggered by the alert evaluation engine.",
    canSchedule: false,
  },
  {
    type: "river-is-back",
    ...
    priority: "normal",
    cooldown: "14d",
    trigger: "evaluate-alerts (external check)",
    condition: "Station becomes runnable again after 14+ days of being unrunnable. Requires checking the last its-on timestamp from alert_state.",
    canSchedule: false,
  },
  {
    type: "nearby-alternative",
    emoji: "\uD83D\uDD04",
    label: "Nearby Alternative",
    priority: "low",
    cooldown: "24h",
    trigger: "Future feature",
    condition: "Suggest a nearby alternative river when the subscribed one is not runnable. Not yet implemented.",
    canSchedule: false,
  },
];
